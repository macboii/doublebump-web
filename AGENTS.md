...
- See [rules/architecture.md](.Codex/rules/architecture.md) — structure & code conventions
- See [rules/styling.md](.Codex/rules/styling.md) — design system & CSS conventions
- See [rules/animation.md](.Codex/rules/animation.md) — pixel phone animation system

## Commands

- `/gitpush` — lint check, commit, and push
- `/update-docs` — analyze session changes and update .Codex docs
