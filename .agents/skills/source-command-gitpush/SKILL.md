---
name: "source-command-gitpush"
description: "Validate, commit, and push changes for the DoubleBump landing page"
---

# source-command-gitpush

Use this skill when the user asks to run the migrated source command `gitpush`.
...
Run: `git add index.html privacy.html terms.html logo.png AGENTS.md .Codex/`
