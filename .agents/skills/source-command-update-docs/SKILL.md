...
description: "Analyze this session's changes and update relevant .Codex documentation"
---
...
|-------------|--------------|
| New section or page layout added | `AGENTS.md` + `rules/architecture.md` |
| CSS design system change (colors, tokens, typography) | `rules/styling.md` |
| Animation logic change | `rules/animation.md` |
| New copy / content update | `AGENTS.md` content section |
| New command created | `AGENTS.md` commands list |
| New reusable JS pattern discovered | `rules/architecture.md` |
| Deploy config change | `AGENTS.md` deploy section |
...
Do NOT add session-specific notes or change history to AGENTS.md.
